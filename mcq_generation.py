...
from modules.duplicate_removal import remove_distractors_duplicate_with_correct_answer, remove_duplicates
from modules.text_cleaning import clean_text
# from ml_models.answer_generation.answer_generator import AnswerGenerator
    ...
    def _generate_distractors(self, context: str, questions: List[Question]) -> List[Question]:
        for question in questions:
            ...
            if len(t5_distractors) < 3:
                ...
                print("Distractors t5:\n",t5_distractors)
                print("\n")
                print("Distractors s2v:\n",s2v_distractors)
            else:
