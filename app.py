...
from modules.mcq_generation import MCQGenerator
from grading.essayGradeHelper import essay_to_wordlist, get_model, getAvgFeatureVecs
...
word2vec_path = 'grading/word2vecmodel (1).bin'
lstm_model_path = 'grading/final_lstm (1).h5'
num_features = 300
...
@app.route("/")
def hello():
    return jsonify('Hello to Major Project!')
...
def generate_mcq():
    try:
        ...
        count = int(requestJson.get('count', 10))  # Default to 10 if count not provided
